...
&nbsp;&nbsp;&nbsp;&nbsp;  For all the members to be ether in tension or compression, the truss should be designed with triangles in mind. There fore, my first scketch came down to this two options:


&nbsp;&nbsp;&nbsp;&nbsp;  In the end sketch AORB was chosen for my design, once I imagined it would distribue the compression and tension loads more uniformly.


**Final design FBD**

&nbsp;&nbsp;&nbsp;&nbsp;  After design was chosen this was the FBD created for it.


**Static Analysis**

&nbsp;&nbsp;&nbsp;&nbsp;  Each joint was analyzed in order to find the highest internal force of the truss, and use it for future steps.
